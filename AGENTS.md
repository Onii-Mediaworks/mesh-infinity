...
## UI Direction
- The Slint UI (`ui/`) is the canonical UI across platforms.
- The SwiftUI app (`NetInfinity/`) is deprecated and should only be referenced for parity checks.
...
- Keep platform-specific code minimal; prefer shared Rust/Slint logic.
